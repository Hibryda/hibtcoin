...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "hibtcoin.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No hibtcoin.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override hibtcoin.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "hibtcoin.pid"));
