...
uint256 hashGenesisBlock("0x47fd5d0b94139921cd071e6429f4510de2531ac9ed08c2e5d1f5975511b1b37c");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    //if(nHeight < 0)
        //nSubsidy = 0;
    if(nHeight > 3679200) // no block reward after reaching 7 years
        nSubsidy = 0;
...
static const int64 nTargetSpacing = 60; // SmallChange: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal hibtcoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x47fd5d0b94139921cd071e6429f4510de2531ac9ed08c2e5d1f5975511b1b37c");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "I just brewed fresh coffee";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1476479896;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 386667404;
        ...
        assert(block.hashMerkleRoot == uint256("0xcfb7d933b17bd637846af1c017a7e7c7d57a1919dfd88a725432047653d254b3"));
