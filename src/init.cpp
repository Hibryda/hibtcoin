    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("SmallChange version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  hibtcoin [options]                     " + "\n" +
                  "  hibtcoin [options] <command> [params]  " + _("Send command to -server or hibtcoin") + "\n" +
                  "  hibtcoin [options] help                " + _("List commands") + "\n" +
                  "  hibtcoin [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "hibtcoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: hibtcoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: hibtcoin.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 19139 or testnet: 19913)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 19131)") + "\n" +
...
//    }
    ...
    // Make sure only a single hibtcoin process is using the data directory.
    ...
    // requested to kill hibtcoin-qt during the last operation. If so, exit.
